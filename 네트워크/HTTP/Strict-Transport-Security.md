## 목차
- [Strict-Transport-Security란?](#strict-transport-security란)
  - [사용법](#사용법)
- [시나리오](#시나리오)
  - [해커에게 어떻게 당하는가](#해커에게-어떻게-당하는가)
  - [HSTS를 사용한다면](#hsts를-사용한다면)
- [HSTS preload list](#hsts-preload-list)
...
- ```preload```: [HSTS preload list](#hsts-preload-list)에 등록할 것인지
